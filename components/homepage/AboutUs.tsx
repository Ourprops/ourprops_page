...
export default function AboutUs() {
    return (
        <div>
            <section className="section2  w-[100%] h-auto flex flex-col lg:flex-row xl:items-start justify-evenly md:py-0 py-10 lg:px-28 sm:px-10 px-5 md:gap-32 gap-x-10 gap-y-0 xl:my-0 my-10">
